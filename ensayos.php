<?php
	$siteTitle="Ensayos | Sedicomvet | Laboratorio de Análisis";
...
<body>
	...
	<div class="padre">
		...
		<div class="p-5 m-5 cajaSombraRedondeadaDer fondo-claro">
			<h2>Ensayos Toxicológicos</h2>
			<hr>
			<div>
				<div class="col-xs-12 col-lg-6">
					<div class="text-justify">
						<h3>Objetivo:</h3>
						<p style="font-size:17px;">Determinar el potencial toxicológico que tienen el producto a objeto de estudio, analizándose los efectos que pueden producir, causar muerte o signos de toxicidad sistemática en animales utilizados en dichos ensayos.</p>
						<p style="font-size:17px;">Se emplea métodos de la EPA, para pruebas, aplicación y los materiales utilizados son las sustancias en estudio, animales, condiciones ambientales, aseguramiento de la salud de los animales.</p>
					</div>
				</div>
				<div class="col-xs-12 col-lg-6">
					<div class="p-5 d-flex justify-content-center">
						<img class="tamano4" src="Imagenes/toxicologicos.jpg" alt="Ensayos Toxicologicos">
					</div>
				</div>
			</div>
		</div>
		...
		<div class="p-5 m-5 cajaSombraRedondeadaDer fondo-claro">
				...
				<div class="col-xs-12 col-lg-6">
					<h3 class="text-center">Animales Utilizados en los Ensayos Toxicológicos</h3>
					<div class="p-5 d-flex justify-content-center">
						
					<table class="table table-striped tabla2 text-center">	
						<thead>
				...
				<div class="col-xs-12 col-lg-6">
					<div>
						<h3>Los ensayos toxicológicos son aplicados de la siguiente manera:</h3>
						<ul class="p-5" style="font-size:17px;">
							<li>Toxicidad Oral Aguda DL50</li>
							<li>Toxicidad Oral Crónica (28 días)</li>
							<li>Toxicidad Inhalatoria Aguda CL50</li>
							<li>Toxicidad Dérmica Aguda</li>
							<li>Irritación Ocular</li>
							<li>Irritación Dérmica Primaria</li>
							<li>Sensibilidad Cutánea</li>
						</ul>
					</div>
				</div>
		</div>
		...
		<div class="p-5 m-5 cajaSombraRedondeadaDer fondo-claro">
			<h2>Ensayos de Eficacia</h2>
			<hr>
			<div>
				<div class="col-xs-12 col-lg-6">
					<div class="text-justify">
						<h3>Objetivo:</h3>
						<p style="font-size:17px;">Brindar estudios de eficacia de alto grado de confiabilidad en el producto investigado. Estudio de eficacia in Vitro, in Vivo utilizando cepas que sea requerido según el bioensayo.</p>
					</div>
				</div>
				<div class="col-xs-12 col-lg-6">
					<div class="p-5 d-flex justify-content-center">
						<img class="tamano4" src="Imagenes/eficacia.jpg" alt="Eficacia">
					</div>
				</div>
			</div>
			<h3 class="text-center">Insectos utilizados en los ensayos de eficacia</h3>
			<div class="p-5 d-flex justify-content-center">
				
				<table class="table table-striped tabla2 text-center">	
						<thead>
							<tr>
								<th class="text-center">Insecto</th>
								<th class="text-center">Cepa</th>
							</tr>
						</thead>
							<tbody>
								...
								<tr>
									<td>Mosquitos</td>
									<td>Anopheles, Aedes aegypti</td>
								</tr>
								<tr>
									<td>Moscas</td>
									<td>Musca doméstica</td>
								</tr>
								<tr>
									<td>Cucarachas</td>
