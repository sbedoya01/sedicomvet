<?php
	...
	$contenido = "El código es: " . $codigo . "<br/>" . "El rif es: " . $rif . "<br/>";
...
<body>
	...
	<header>
			...
			<h1 style="padding-top:100px; color:#333391">Favor enviar el archivo generado y copia del R.I.F. en PDF al correo: </h1>
			<br>
			<div class="p-5 text-center">
				<a href="mailto:sedicomvet@hotmail.com"><h1>sedicomvet@hotmail.com</h1></a>
			</div>
		...
		<div class="p-5">
			<div class=" text-center p-5"><a href="index.php"><h2 class="p-3 cajaSombraRedondeadaDer fondo-azul">Ir al inicio</h2></a></div>
		</div>
