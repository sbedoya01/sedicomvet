<?php
	$siteTitle="Formularios | Sedicomvet | Laboratorio de Análisis";
...
<body>
	...
	<header>
			...
			<h1 style="padding-top:100px; color:#333391">FORMULARIOS</h1>

		</header>
		<hr class="ml-5 mr-5" style="background-color:#333391; height:1px;">
		
		<div class="p-5">
			<div class="col-xs-12 col-lg-4 text-center p-5"><a href="cotizacion"><h2 class="p-3 cajaSombraRedondeadaDer fondo-azul">Solicitud de Cotización</h2></a></div>
			<div class="col-xs-12 col-lg-4 text-center p-5"><a href="muestras"><h2 class="p-3 cajaSombraRedondeadaDer fondo-blanco">Envío de Muestras</h2></a></div>
			<div class="col-xs-12 col-lg-4 text-center p-5"><a href="nuevos-clientes"><h2 class="p-3 cajaSombraRedondeadaDer fondo-claro">Registro Nuevos Clientes</h2></a></div>
			<div class="d-flex justify-content-center text-center p-5"><a href="Documentos/Triptico-Sedicomvet.pdf" download="Triptico-Sedicomvet.pdf"><h2 class="p-3 cajaSombraRedondeadaDer fondo-claro">Descargar Tríptico de Servicios</h2></a></div>
		</div>
