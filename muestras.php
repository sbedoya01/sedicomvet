<?php
	$siteTitle="Envío de Muestras | Sedicomvet | Laboratorio de Análisis";
...
<body>
	...
	<header>
			...
			<h1 class="m-2" style="padding-top:100px; color:#333391">Formulario para envío de muestras</h1>
		...
		<form action="recibido.php" name="muestras" method="post" class="formulario">
				...
				<div class="row form-group"><h3>REGISTRO DE SANIDAD?</h3></div>
				
				<div class="row form-group">
					<div class="col form-group"><button onClick = "sanidadSi();" type="button" class="btn btn-primary btn-lg">Si</button></div>
					<div class="col form-group"><button onClick = "sanidadNo();" type="button" class="btn btn-primary btn-lg">No</button></div>
				</div>
				...
				<div class="text-center p-5">
					<button onClick = "generatePDF2();" type="submit" class="btn btn-primary btn-lg">Crear Archivo</button>
				</div>
	...
	<script src="js/genPDF2.js"></script>
</body>
</html>